    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.left}>
          <TouchableOpacity onPress={() => props.handleClickIntoAvatar()}>
            {props.image ? (
        ...
        <View style={styles.right}>
          <TouchableOpacity onPress={() => props.handleClickToCreateButtonEvent(typeChoose)} style={styles.wrapInput}>
            <Text style={styles.txtInput}>Hay nhap noi dung bai viet</Text>
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.buttonChooseTypePost}>
        ...
        >
          <FontAwesome5Icon name='poll' size={20} color={typeChoose == TYPE_SURVEY_POST ? COLOR_WHITE : COLOR_GREY} />
          <Text
            style={
              typeChoose == TYPE_SURVEY_POST
        ...
        {props.role === TYPE_POST_STUDENT || props.role === TYPE_POST_FACULTY ? null : (
          <TouchableOpacity
          ...
          >
            ...
            <Text
              style={
                typeChoose == TYPE_RECRUITMENT_POST
                  ? styles.txtButtonChooseTypePostActive
                  : styles.txtButtonChooseTypePostUnActive
              }
            >
        ...
        >
          <IoniconsIcon name='create' size={20} color={typeChoose == TYPE_NORMAL_POST ? COLOR_WHITE : COLOR_GREY} />
          <Text
            style={
              typeChoose == TYPE_NORMAL_POST
                ? styles.txtButtonChooseTypePostActive
                : styles.txtButtonChooseTypePostUnActive
            }
          >
