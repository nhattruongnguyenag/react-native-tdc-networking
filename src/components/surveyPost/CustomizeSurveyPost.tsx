    ...
    <>
      <View style={styles.container}>
        <View style={styles.leftContainer}>
          <TouchableOpacity onPress={() => props.handleClickIntoAvatarAndNameAndMenuEvent(0)}>
            {props.image != null ? (
        ...
        <View style={styles.rightContainer}>
          <View style={styles.rightContainerTopTitle}>
            <Text style={styles.name}>
              {props.name}{' '}
              <View>
                <Text style={[styles.itemType, styles.textTypePost]}>{TEXT_SURVEY}</Text>
              </View>
            </Text>
          ...
          <View style={styles.rightContainerBottom}>
            <View style={[styles.rowAndCenter, styles.item]}>
              ...
              <Text style={styles.address}> {props.createdAt}</Text>
            </View>
          </View>
        </View>
      </View>
