  ...
  if (post.role === 0) {
    return (
      <View style={styles.wrapHeader}>
        {/* Avatar company */}
        <Image style={styles.headerAvatar} source={{ uri: post.avatar }} />
        <View style={styles.wrapLeftHeader}>
          <View>
            ...
            <View style={styles.headerCenterTop}>
              {/* Time created post */}
              <Text style={[styles.headerCenterTimePost, styles.headerItem]}>
                {post.timeCreatePost} - {post.type}
              </Text>
              {/* in ability? */}
              <View style={[styles.headerCenterType, styles.headerItem]}>
                <Text style={styles.headerTxt}>{post.available ? TEXT_AVAILABLE : null}</Text>
              </View>
              {/* Type author */}
