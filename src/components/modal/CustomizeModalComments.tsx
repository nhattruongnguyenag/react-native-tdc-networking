...
import {
  TEXT_CHAR,
  TEXT_HIDDEN_COMMENTS,
  TEXT_PLACEHOLDER_INPUT_COMMENT,
  TEXT_SEE_MORE_COMMENTS,
  TEXT_TITLE_COMMENT,
  TEXT_WARNING_CONTENT_COMMENT_NULL,
  TEXT_WARNING_CONTENT_COMMENT_NUMBER_LIMITED,
  TEXT_WARNING_CREATE_COMMENT_FAIL
...
const CustomizeModalComments = () => {
  ...
  const { modalCommentData, userIdOfProfileNow, currentScreenNowIsProfileScreen } = useAppSelector(
  ...
  const handleSubmitEvent = () => {
    if (isNotBlank(myComment.trim()) && isLengthInRange(myComment, NUMBER_MIN_CHARACTER, NUMBER_MAX_CHARACTER)) {
      ...
      if (isBlank(myComment.trim()) && isLengthInRange(myComment, NUMBER_MIN_CHARACTER, NUMBER_MAX_CHARACTER)) {
        ...
        Alert.alert(
          TEXT_WARNING_CREATE_COMMENT_FAIL,
          TEXT_WARNING_CONTENT_COMMENT_NUMBER_LIMITED + NUMBER_MAX_CHARACTER + ' ' + TEXT_CHAR
        )
      }
    }
  }
