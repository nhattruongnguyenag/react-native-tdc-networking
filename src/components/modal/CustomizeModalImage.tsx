...
const CustomizeModalImage = () => {
    ...
    return (
        ...
        >
                        ...
                        <TouchableOpacity
                            ...
                            <Pressable
                                ...
                                <View style={styles.wrapHeaderModalImage}>
                                    <Pressable style={styles.userInfoRight}
                                        onPress={() => console.log('go to profile')
                                        }>
                                        <Image
                                            style={styles.avatar}
                                            source={{ uri: modalImageData?.avatar }}
                                        />
                                        <Text style={styles.useName} numberOfLines={1}>{modalImageData?.name}</Text>
                                    </Pressable>
                                    <TouchableOpacity
                                        onPress={() => {
                                            dispatch(closeModalImage())
            ...
            <View style={{ flexDirection: 'row', position: 'absolute', bottom: '15%', width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                {
                    modalImageData?.images.map((item, index) => (
