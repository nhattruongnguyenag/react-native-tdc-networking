    ...
    <View style={styles.wrapBottom}>
      <View style={[styles.wrapBottomLeft, styles.row]}>
        ...
        <View style={[styles.wrapIconAndTextBottom, styles.iconRight]}>
          <TouchableOpacity onPress={() => handleClickIntoBtnIconComments()}>
            {!props.isComment ? (
      ...
      <View style={[styles.wrapBottomRight, styles.row]}>
        <Text style={styles.bottomWrapRightText}>{TEXT_LIKE_BY}</Text>
        {numberUserReacted > 3 ? (
          <TouchableOpacity
          ...
          <>
            {props.likes.map((item, index) => (
              <TouchableOpacity onPress={() => handleClickIntoListUserReactions()} key={item.id}>
                <Image style={[styles.avatarUserReacted]} source={{ uri: item.avatar }} />
              </TouchableOpacity>
            ))}
          </>
        )}
