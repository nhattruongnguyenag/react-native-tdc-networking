    ...
    <View style={styles.containerInfo}>
      ...
      <View style={[styles.buttonContainer, styles.paddingBottom]}>
        ...
        >
          ...
          <Text style={styles.txtContentBtn}>Gọi điện</Text>
        </TouchableOpacity>
        <TouchableOpacity
      ...
      <View>
        <View style={styles.infoContainer}>
          <IconIonicons style={styles.iconInfo} name='bag-remove-outline' size={20} color={COLOR_BLACK} />
          <Text style={styles.textInfo}>Chức vụ: {props.position}</Text>
        </View>
        <View style={styles.infoContainer}>
