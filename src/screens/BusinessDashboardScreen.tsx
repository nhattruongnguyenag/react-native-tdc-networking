    ...
    <View style={styles.container}>
      <ScrollView>
        <CustomizeBusinessPost
          name={'Google VNaaaaaaaaaaaaaaaaa'}
          ...
          content={' danh CollodiNhững cuộc phiêu lưu của Pinocchio, được xuất bản năm 1883, là cuốn tiểu thuyết dành cho thiếu nhi của tác giả  cuốn tiểu thuyết dành cho thiếu nhi của tác giả người Ý Carlo Lorenini d dưới bút danh Collodi'}
          images={null}
          type={'tuyển dụng'}
          likes={10}
          isLike={true}
