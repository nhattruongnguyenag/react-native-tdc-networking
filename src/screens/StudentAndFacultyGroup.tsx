...
import { TYPE_NORMAL_POST, TYPE_POST_BUSINESS, TYPE_POST_FACULTY, TYPE_POST_STUDENT, TYPE_RECRUITMENT_POST } from '../constants/Variables'
...
export default function StudentAndFacultyGroup() {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {
                    userLoginAllowCreatePost(userLogin?.roleCodes ?? "") ? <View style={styles.toolbarCreatePost}>
