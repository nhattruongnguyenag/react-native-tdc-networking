import {
  AUTOMOBILE_ENGINEERING_DEPARTMENT,
  FACULTY_AUTOMATION_TECHNOLOGY,
  FACULTY_MECHANICAL_ENGINEERING_AND_MANUFACTURING,
  FACULTY_OF_BUSINESS_ADMINISTRASION,
  FACULTY_OF_ELECTRICAL_ENGINEERING,
  FACULTY_OF_ENGLISH,
  FACULTY_OF_FINANCE_AND_ACCOUNTING,
  FACULTY_OF_INFORMATION_TECHNOLOGY,
  FACULTY_OF_JAPANESE_LANGUAGE,
  FACULTY_OF_KOREAN_LANGUAGE,
  FACULTY_OF_TOURISM
